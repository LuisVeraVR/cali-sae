...
class JuanCamiloRosasTab(QWidget):
    ...
    def _create_config_section(self) -> QFrame:
        ...
        self.municipality_input.setPlaceholderText("Ej: Cali, Bogotá, Medellín, Pereira, Buenaventura")
    ...
    def _create_conversion_info(self) -> QFrame:
        ...
        label = QLabel("Conversión de unidades aplicadas:")
        label.setFont(QFont("Arial", 10, QFont.Weight.Bold))
        label.setStyleSheet("color: #2c3e50;")
        layout.addWidget(label)

        conversions = [
            "- Productos con gramos (ej: BLANQUILLO*400G): (gramos × cantidad) ÷ 1000 × factor",
            "- Granos/Frijol/Lenteja: Factor 25",
            "- Harina: Factor 24",
            "- Pastas: Factor 24",
            "- Atún: Factor 48",
            "- Aceite: Factor 25",
            "- Productos sin gramos: Cantidad original sin conversión"
        ]
